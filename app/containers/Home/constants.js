...
export const FILTER = 'app/Home/FILTER';
export const FILTER_SUCCESS = 'app/Home/FILTER_SUCCESS';
export const FILTER_ERROR = 'app/Home/FILTER_ERROR';
export const SORT = 'app/Home/SORT';
export const SORT_SUCCESS = 'app/Home/SORT_SUCCESS';
export const SORT_ERROR = 'app/Home/SORT_ERROR';
